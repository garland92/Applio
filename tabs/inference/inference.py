...
def update_sliders(preset):
    ...
    return (
        ...
        values.get("pitch_shift", False),
        values.get("limiter", False),
        values.get("gain", False),
        values.get("distortion", False),
        values.get("chorus", False),
        values.get("bitcrush", False),
        ...
        values.get("reverb_wet_gain", 0.33),
        values.get("reverb_dry_gain", 0.4),
        values.get("reverb_width", 1.0),
        values.get("reverb_freeze_mode", 0.0),
        values.get("pitch_shift_semitones", 0),
        values.get("limiter_threshold", -6),
        values.get("limiter_release_time", 0.05),
        values.get("gain_db", 0),
        values.get("distortion_gain", 25),
        values.get("chorus_rate", 1.0),
        values.get("chorus_depth", 0.25),
        values.get("chorus_center_delay", 7),
        values.get("chorus_feedback", 0.0),
        values.get("chorus_mix", 0.5),
        values.get("bitcrush_bit_depth", 8),
        values.get("clipping_threshold", -6),
        values.get("compressor_threshold", 0),
        values.get("compressor_ratio", 1),
        values.get("compressor_attack", 1.0),
        values.get("compressor_release", 100),
        values.get("delay_seconds", 0.5),
...
def get_presets_data(pitch, index_rate, rms_mix_rate, protect, 
                    autotune, autotune_strength, clean_audio, clean_strength,
                    ...
                    reverb_width, reverb_freeze_mode, pitch_shift_semitones,
                    limiter_threshold, limiter_release_time, gain_db,
                    distortion_gain, chorus_rate, chorus_depth, chorus_center_delay,
                    chorus_feedback, chorus_mix, bitcrush_bit_depth,
                    clipping_threshold, compressor_threshold, compressor_ratio,
                    compressor_attack, compressor_release, delay_seconds,
